...
\subsection{Role}\label{sec:Role}
...
\setcounter{paragraph}{0}
\subsection{Project}\label{sec:DLocation}
\paragraph{constraints}
\paragraph{name} 250 characters, alphanumeric and spaces 
\paragraph{hasMany}

\setcounter{paragraph}{0}
\subsection{Role}\label{sec:DLocation}
\paragraph{constraints}
\paragraph{mapping}
\paragraph{authority}
\paragraph{type}
...
\setcounter{paragraph}{0}
\subsection{Timesheet}\label{sec:DLocation}
\paragraph{constraints}
\paragraph{hasMany}
\paragraph{date}
\paragraph{project}
...
\hline
\multicolumn{1}{|c||}{ }&
\multicolumn{7}{|c||}{Functional} &
\multicolumn{2}{|c|}{Non-functional}\\
\hline
	& \s{3.1.1} & \s{3.1.2}&\s{3.1.3}&\s{3.1.4}&\s{3.1.5}&\s{3.1.6}&\s{\sout{3.1.7}}&\s{3.2.1}&\s{3.2.2} \\
\hline
\hline
~\ref{sec:Update}	&&&&&&&&&\\
~\ref{sec:Update}	&&&&&&&&&\\
